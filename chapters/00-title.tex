...
Mgr. Pavel Hubáček, Ph.D., department
%%% First and last name of supervisor with academic titles
...
Abstract:
Zero-knowledge proofs allow the prover to convince the verifier that a statement is true without revealing any information about the statement itself. Such systems maintain privacy and confidentiality while still establishing trust and validity in digital interactions. The need for more efficient and scalable zero-knowledge proofs arises from the growing demand in various applications, including blockchain technology, financial transactions, and data privacy. However, the added properties lead to proof systems, which are computationally expensive and require significant resources. With these concerns in mind, a protocol $\plonk$ was created. While there are few articles discussing this protocol formally, there is a lack of middle ground with a clear yet precise explanation of the protocol. The aim of this work is to explain the $\plonk$ in detail and implement algebraic techniques to speed up the protocol.

Keywords:
cryptography, SNARK, zero-knowledge
\vss}
