...
\renewcommand{\arraystretch}{1.5} % Increase table row spacing by 50
%%% Each chapter is kept in a separate file
\include{chapters/preface}
\include{chapters/01-preliminaries}
\include{chapters/02-background}
\include{chapters/03-plonk}
\include{chapters/04-analysis}
\include{chapters/05-optimizations}
